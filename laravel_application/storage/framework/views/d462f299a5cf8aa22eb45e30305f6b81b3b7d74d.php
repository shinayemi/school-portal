        ...
        <div class="cs-topbar">
            <div class="container">
                ...
                <ul class="nav navbar-nav navbar-right" style="margin-top: 5px;">
                    ...
                    <li><a href="https://codecanyon.net/item/menorahoes-online-learning-and-examination-system/19361996" class="cs-nav-btn visible-lg yellow-buy" style="border-radius: 50px; background-color:#ff9800;"> <?php echo e(getPhrase('Buy_Now')); ?></a></li>
                    <?php endif; ?>
